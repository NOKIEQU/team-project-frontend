...
export default function LoginPage() {
    ...
    const Submitt = (e) => {
        ...
        if (validateEmail(email)) {
            // here is where the connection would go after logging in
        } else {
    ...
    {/* Different validations for emails to prevent conflict */}
...
<div className="relative w-full h-full overflow-hidden z-10">
    <Image
        src="/back3.jpg"
        layout="fill"
        className="object-cover hidden md:block transform transition-transform duration-1000 hover:-translate-x-12"
        alt="Sliding Logo"
    />
</div>
</div>
            ...
            <div className="w-full mt-[22vh] sm:mt-[22vh] md:mt-[30vh] md:ml-[17vw] flex justify-center md:col-span-1">
                <form className="flex flex-col items-center space-y-4 w-full md:w-[600px]" onSubmit={Submitt}>
                    <div className="flex items-center justify-center mt-12 md:mt-[-20px]">
                    ...
                    <button
                        className="mt-4 p-2 w-[80%] sm:w-full md:w-[600px] bg-[#f6a302] text-white rounded-md hover:bg-[#fa9a00ef]"
                    >
                        LOGIN
                    </button>
                    ...
                    <div className="mt-4 text-center">
                        <p className="text-sm text-white">
                            ...
                            <Link href="/register">
                                <span className="text-[#f6a302] hover:underline">Sign up here</span>
                            </Link>
                        </p>
                        <br />
                        <p className="text-sm text-white">
                            Admin?{' '}
                            <Link href="/admin">
                                <span className="text-[#f6a302] hover:underline">Click this link</span>
                            </Link>
                        </p>
                    </div>
                </form>
        ...
        <div className="bg-[#0d1b2a] p-4 sm:p-6 w-full max-w-[90%] sm:max-w-sm border border-[#f6a302] rounded-md">
            {ThankYou ? (
                <div className="text-center">
                    <h2 className="text-lg font-bold mb-4 text-white sm:text-xl">Thank You!</h2>
                ...
                <>
                    <h2 className="text-lg font-bold mb-4 text-white sm:text-xl">Reset Password</h2>
                    <p className="text-sm sm:text-base mb-4 text-white">
                    ...
                    />
                    {popupEmailError && (
                        <p className="text-red-500 text-sm mt-2">{popupEmailError}</p>
                    )}
