    ...
    <div className="absolute top-0 right-0 h-full w-full lg:w-1/2 bg-[#0d1b2a] opacity-90">
      <div className="flex flex-col w-full h-full px-6 lg:px-10 lg:pt-20 gap-y-8 ">
        ...
        <p className="text-base lg:text-lg leading-relaxed">
          ...
          starting your journey, we have everything you need to explore, learn,
          and grow. Dive into our curated collections, find new favorites, and
          connect with others who share your passion. The possibilities are
          endless, and the adventure starts right here!
        </p>
  ...
  <div className="flex flex-col lg:flex-row w-full bg-[#0d1b2a] py-10 px-6 lg:px-20 shadow-xl">
    ...
    <div className="flex flex-col w-full lg:w-1/2 mt-10 lg:mt-16 lg:pl-10">
      ...
      <p className="text-base lg:text-lg leading-relaxed mb-6">
        ...
        felis nec ante. Sed ultricies, ipsum sit amet cursus facilisis, lectus
        lectus malesuada tortor, vel pharetra neque purus non est. Vivamus
        lobortis tincidunt lorem, a fermentum tortor condimentum ac. Aliquam
        erat volutpat. Nam convallis urna id nunc tincidunt, non euismod lorem
        ultricies.
      </p>
      <p className="text-base lg:text-lg leading-relaxed">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut aliquet,
